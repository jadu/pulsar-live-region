...
var $ = require('jquery');
var LiveRegionService = require('./src/LiveRegion');

$(function () {
    var liveRegion = new LiveRegionService($('html'));
...
var LiveRegion = function () {
    ...
    _createClass(LiveRegion, [{
        ...
        value: function init() {
            ...
            if (_typeof(options.assertiveContainer) === undefined) {
            ...
            if (_typeof(options.politeContainer) === undefined) {
