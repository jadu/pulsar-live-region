...
var _LiveRegion = require('./src/LiveRegion');
...
(0, _jquery2.default)(function () {
    var liveRegion = new _LiveRegion2.default((0, _jquery2.default)('html'));
    ...
    (0, _jquery2.default)('.js-trigger-polite').on('click', function () {
        return liveRegion.polite('this is a polite annoucement');
    });
    (0, _jquery2.default)('.js-trigger-assertive').on('click', function () {
        return liveRegion.assertive('this is an assertive annoucement');
    });
});

},{"./src/LiveRegion":3,"jquery":2}],2:[function(require,module,exports){
/*!
...
var LiveRegion = function () {
    ...
    _createClass(LiveRegion, [{
        ...
        key: 'assertive',
        value: function assertive(content) {
            var $assertiveContainer = this.$html.find(this.assertiveContainer);
        ...
        key: 'polite',
        value: function polite(content) {
            var $politeContainer = this.$html.find(this.politeContainer);
